...
export default function SecurityView({ onBack }: SecurityViewProps) {
  ...
  const getStatusBadgeColor = (status: SecurityVulnerability['status']) => {
    switch (status) {
      case 'open':
            ...
            <div className="flex items-start justify-between mb-4">
              <div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className={`px-2 py-1 rounded-full text-sm border ${getStatusBadgeColor(vulnerability.status)}`}>
